...
namespace VIDE_Data
{
    ...
    */
    ...
    public class Diags
    {
        ...
        public List<DialogNode> playerNodes = new List<DialogNode>();
    ...
    public class DialogNode
    {
        ...
        public DialogNode(int comSize, int id, string tag)
        {
            comment = new List<Comment>();
            ID = id;
            playerTag = tag;
        ...
        public DialogNode(DialogNode n)
        {
            if (n == null) return;
            ID = n.ID;
    ...
    public class Comment
    {
        ...
        public DialogNode inputSet;
        public DialogNode outNode;
    ...
    public class VD : MonoBehaviour
    {
        ...
        private static DialogNode currentPlayerStep;
        ...
        private static string[] GetOptions(DialogNode diagNode)
        {
        ...
        private static string[] GetExtraData(DialogNode diagNode)
        {
            List<string> op = new List<string>();
        ...
        {
            diags[currentDiag].playerNodes.Add(new DialogNode(cSize, id, tag));
        }
        ...
        public static bool Load(string dName)
        {
            ...
            for (int i = 0; i < pDiags; i++)
            {
                ...
                DialogNode com = diags[currentDiag].playerNodes[diags[currentDiag].playerNodes.Count - 1];
            ...
            for (int i = 0; i < nDiags; i++)
            {
                ...
                diags[currentDiag].playerNodes.Add(new DialogNode());
        ...
        public static Diags PreloadLoad(string dName)
        {
            ...
            for (int i = 0; i < pDiags; i++)
            {
                ...
                theDiag.playerNodes.Add(new DialogNode((int)((long)dict["pd_comSize_" + i.ToString()]),
                    (int)((long)dict["pd_ID_" + i.ToString()]),
                    tagt));

                DialogNode com = theDiag.playerNodes[theDiag.playerNodes.Count - 1];
            ...
            for (int i = 0; i < nDiags; i++)
            {
                ...
                theDiag.playerNodes.Add(new DialogNode());
        ...
        static AudioClip[] GetPlayerAudios(DialogNode diagNode)
        {
        ...
        static Sprite[] GetPlayerSprites(DialogNode diagNode)
        {
        ...
        private static NodeData GetNodeDataForPlayer(DialogNode diagNode)
        {
        ...
        static void SetVisibility(NodeData nd, DialogNode diagNode)
        {
        ...
        public static void UnloadDialogues()
        {
            foreach (Diags d in diags)
            {
                d.playerNodes = new List<DialogNode>();
        ...
        public static NodeData GetNodeData(string dialogueName, int id, bool forceLoad)
        {
            ...
            currentDiag = -1;
            DialogNode realNode = currentPlayerStep;
        ...
        public static NodeData GetNext(bool returnNextComment, bool callAction)
        {
            ...
            DialogNode currentPlayerStepB = new DialogNode(currentPlayerStep);
        ...
        {
            DialogNode evs = GetPN(dialogueName, nodeID);
            if (evs != null)
            {
        ...
        static DialogNode GetPN(string dialogueName, int nodeID)
        {
            int diag = -1;
    ...
    public class VD2
    {
        ...
        private DialogNode currentPlayerStep;
        ...
        private string[] GetOptions(DialogNode diagNode)
        {
            List<string> op = new List<string>();
        ...
        private string[] GetExtraData(DialogNode diagNode)
        {
            List<string> op = new List<string>();
        ...
        AudioClip[] GetPlayerAudios(DialogNode diagNode)
        {
            List<AudioClip> au = new List<AudioClip>();
            foreach (Comment c in diagNode.comment)
                au.Add(c.audios);
        ...
        Sprite[] GetPlayerSprites(DialogNode diagNode)
        {
            List<Sprite> sp = new List<Sprite>();
            foreach (Comment c in diagNode.comment)
                sp.Add(c.sprites);
        ...
        private NodeData GetNodeDataForPlayer(DialogNode diagNode)
        {
            NodeData nd = new NodeData();
        ...
        void SetVisibility(NodeData nd, DialogNode diagNode)
        {
            List<string> coms = new List<string>();
            List<Comment> cRefs = new List<Comment>();
            List<string> exd = new List<string>();
        ...
        DialogNode GetPN(string dialogueName, int nodeID)
        {
            int diag = -1;

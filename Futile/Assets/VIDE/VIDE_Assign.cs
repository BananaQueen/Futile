...
public class VIDE_Assign : MonoBehaviour, ISerializationCallbackReceiver
{
    ...
    public List<DialogNode> playerDiags = new List<DialogNode>();
    ...
    */
    ...
    public void OnAfterDeserialize()
    {
        if (S_playerDiags.Count > 0)
            ...
            playerDiags = new List<DialogNode>();
    ...
    List<DialogNode> PlayerDeserialize()
    {
        List<DialogNode> temp_playerDiags = new List<DialogNode>();
        foreach (var child in S_playerDiags)
        {
            temp_playerDiags.Add(new DialogNode());
            ...
            {
                DialogNode s = temp_playerDiags[temp_playerDiags.Count - 1];
